...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">Verify Soil</div>
            <div class="panel-body">
                <?php
                echo form_open_multipart(base_url('land/do-verify-soil'), ['id' => 'verify-soil-form'], ['land_id' => $land['land_id']]);
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    echo form_dropdown(['name' => 'organization_id', 'id' => 'organization_id', 'class' => 'form-control', 'placeholder' => 'Organization'], $organizations, set_value($land['organization_id']));
                                    echo '</div>';
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-md-offset-2"> 
                            ...
                            ?>">Max Allowed file size is 5 MB and type allowed jpg/png.</div>
                        </div>
                    </div>
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <?php
                            echo '<div class="form-group">';
                            echo form_label('Soil Type', '', ['for' => 'soil_type', 'class' => 'control-label']);
                            echo form_dropdown(['name' => 'soil_type', 'id' => 'soil_type', 'class' => 'form-control'], $soils, $land['soil_type_id']);
                            echo '</div>';

                            echo '<div class="form-group">';
                            echo form_label('Approval Status', '', ['for' => 'is_verified', 'class' => 'control-label']);
                            echo form_dropdown(['name' => 'is_verified', 'id' => 'is_verified', 'class' => 'form-control'], ['Approved' => 'Approved', 'Rejected' => 'Rejected'], $land['is_verified']);
                            echo '</div>';

                            echo '<div class="form-group">';
                            echo form_label('Comments', '', ['for' => 'comments', 'class' => 'control-label']);
                            echo form_textarea(['name' => 'comments', 'id' => 'comments', 'class' => 'form-control', 'placeholder' => 'Reason', 'rows' => 4], set_value('is_verified', $land['soil_verification_comments']));
                            echo '</div>';
                            ?>
                        </div>
                        <div class="col-md-4 col-md-offset-2">
                            <div id="verify-docs" class="dropzone">Max Allowed file size is 5 MB and type allowed pdf/doc.</div>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-md-3">
                            <?php echo form_label('Tree Selection') ?>
                        </div>
                        <div class="col-md-3">
                            <?php echo form_dropdown(['name' => 'select_tree_name', 'id' => 'select_tree_name', 'class' => 'form-control'], $trees); ?>
                        </div>
                        <div class="col-md-3">
                            <?php echo form_dropdown(['class' => 'form-control', 'name' => 'season', 'id' => 'season'], ['Autumn' => 'Autumn', 'Mansoon' => 'Mansoon', 'Spring' => 'Spring', 'Summer' => 'Summer', 'Winter' => 'Winter']); ?>
                        </div>
                        <div class="col-md-3">
                            <?php echo form_button(['name' => 'add_tree_btn', 'id' => 'add_tree_btn', 'class' => 'btn btn-sm btn-danger', 'data-id' => $land['land_id'], 'data-url' => base_url('land/add-tree-suggestion')], 'Add'); ?>
                        </div>
                    </div>
                    <br>
                    <div id="suggested-tree"><?php echo $itemlist; ?></div>
                </fieldset>
                <hr>
                <div class="row">
                    <div class="col-md-12">
