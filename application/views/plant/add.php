                    ...
                    <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                echo form_textarea(['name' => 'plant_description', 'id' => 'plant_description', 'class' => 'form-control', 'placeholder' => 'Plant Description', 'rows' => 4, 'maxlength' => 500], (isset($plant) && isset($plant['description'])) ? set_value('plant_description', $plant['description']) : '');
                                echo '</div>';
                                ?>
                            </div>
                        </div>
